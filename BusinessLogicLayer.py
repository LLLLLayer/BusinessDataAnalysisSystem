...
class BusinessProcess:
    ...
    def Searchsome(self):
        db = pymysql.connect("awstest.cuo6db9gvsjw.us-east-1.rds.amazonaws.com", "admin", "12345678", "testDB")
        cursor = db.cursor()
        sqlDate = "SELECT 日期 FROM StockMarket"  # 日期
        # 日期
    ...
    def CreatMatplotlib(self):
        ...
        if(self.queries=="前收盘价和开盘价"):
            ...
            plt.xticks(xTicks)
            plt.legend()
        plt.savefig("/Users/layer/PycharmProjects/BusinessDataAnalysisSystem/temp.png")
        return f
